...
project = "yancc"
copyright = "2025, Rory Conlin"
author = "Rory Conlin"
version = yancc.__version__
release = version
...
top_level = "yancc"
linkcode_blob = "head"
linkcode_url = r"https://github.com/f0uriest/yancc/"
...
latex_elements = {
    ...
    \begin{titlepage}
        ...
        \centering
        \textbf{\Huge {yancc Documentation}}
