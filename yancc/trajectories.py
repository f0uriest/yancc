...
class DKESTrajectories(cola.ops.Sum):
    ...
    def __init__(
        ...
        rdot1 = DKESTrajectoriesSurface1(field, speedgrid, pitchgrid, species, E_psi)
        rdot2 = DKESTrajectoriesSurface2(field, speedgrid, pitchgrid, species, E_psi)
        xidot = DKESTrajectoriesPitch(field, speedgrid, pitchgrid, species, E_psi)
...
class DKESTrajectoriesPitch(FullTrajectoriesPitch1):
...
class DKESTrajectoriesSurface1(FullTrajectoriesSurface1):
